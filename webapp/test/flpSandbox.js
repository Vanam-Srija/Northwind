		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comustnorthwindnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comustnorthwindnorthwind-display": {
								"semanticObject": "comustnorthwindnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ust.northwind.northwind",
									"url": sap.ui.require.toUrl("com/ust/northwind/northwind")
								}
							}
						}
					}
